...
function BreakingNewsCard({
  ...
  return (
    <div className="flex bg-gray-900 text-white rounded-lg overflow-hidden shadow-lg mt-1">
  ...
  <div className="flex flex-col justify-between p-4">
    <div>
      ...
      <p className="text-gray-400 md: max-h-16 lg: max-h-24 overflow-hidden">{description}</p>
    </div>
