          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 caret-gray-600"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                name="category"
                id="category"
                className="block w-full rounded-md border-0 px-3.5 py-2 pl-20 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 caret-gray-600"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
